// Prompt const every time you test you will be require to imput speed
const prompt = require('prompt-sync')();
// Assign the prompt output message by using let variable
...
function netSalaryCalculator(){
    // calculates total gross  salary
    let grossIncome = (+basicSalary+ +benefits)
   // outputs gross salary when tested
